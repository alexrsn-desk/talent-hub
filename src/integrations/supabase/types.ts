...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      portal_candidate_stage_overrides: {
        Row: {
          candidate_id: string
          created_at: string
          id: string
        ...
        Relationships: [
          {
            foreignKeyName: "portal_candidate_stage_overrides_candidate_id_fkey"
            columns: ["candidate_id"]
            isOneToOne: false
            referencedRelation: "portal_candidates"
            referencedColumns: ["id"]
      ...
      portal_settings: {
        Row: {
          created_at: string
          default_notify_candidate_on_interview: boolean
          default_notify_candidate_on_reject: boolean
